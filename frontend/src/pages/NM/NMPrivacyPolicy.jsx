        ...
        <div className='w-full bg-gradient-to-b from-orange-50 to-white py-16'>
            <div className='max-w-4xl mx-auto px-4'>
                ...
                <div className='text-center mb-12'>
                    ...
                    <h1 className='text-3xl font-light text-orange-800 mb-3'>Privacy Policy</h1>
                ...
                <div className='bg-white rounded-xl shadow-lg border border-orange-100 p-8 mb-8'>
                    ...
                    <div className='mb-8'>
                        <h2 className='text-xl font-medium text-orange-800 mb-3 flex items-center gap-2'>
                            <FontAwesomeIcon icon={faShield} className='text-orange-400' />
                    ...
                    <div className='mb-8'>
                        <h2 className='text-xl font-medium text-orange-800 mb-3'>Information We Collect</h2>
                        <div className='space-y-4'>
                            <div>
                                <h3 className='font-medium text-orange-700 mb-2'>Job Applicant Information</h3>
                            ...
                            <div>
                                <h3 className='font-medium text-orange-700 mb-2'>Employer Information</h3>
                                <p className='text-gray-600 text-sm leading-relaxed'>
                    ...
                    <div className='mb-8'>
                        <h2 className='text-xl font-medium text-orange-800 mb-3'>How We Use Your Information</h2>
                    ...
                    {/* Information Sharing */}
                    <div className='mb-8'>
                        <h2 className='text-xl font-medium text-orange-800 mb-3'>Information Sharing</h2>
                    ...
                    <div className='mb-8'>
                        <h2 className='text-xl font-medium text-orange-800 mb-3 flex items-center gap-2'>
                            <FontAwesomeIcon icon={faUserLock} className='text-orange-400' />
                            Data Security
                        </h2>
                        <p className='text-gray-600 text-sm leading-relaxed'>
                    ...
                    {/* Your Rights */}
                    <div className='mb-8'>
                        <h2 className='text-xl font-medium text-orange-800 mb-3'>Your Rights</h2>
                        <p className='text-gray-600 text-sm leading-relaxed mb-2'>
                    ...
                    {/* Changes to Policy */}
                    <div className='mb-8'>
                        <h2 className='text-xl font-medium text-orange-800 mb-3'>Changes to This Policy</h2>
                        <p className='text-gray-600 text-sm leading-relaxed'>
                    ...
                    <div className='bg-orange-50 p-6 rounded-lg'>
                        <h2 className='text-xl font-medium text-orange-800 mb-3'>Contact Our Data Protection Officer</h2>
