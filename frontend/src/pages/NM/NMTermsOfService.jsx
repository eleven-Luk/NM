        ...
        <div className='w-full bg-gradient-to-b from-orange-50 to-white py-8 sm:py-12 md:py-16'>
            ...
            <div className='max-w-4xl mx-auto px-4 sm:px-6'>
                ...
                <div className='text-center mb-8 sm:mb-12'>
                    ...
                    <h1 className='text-2xl sm:text-3xl font-light text-orange-800 mb-2 sm:mb-3'>Terms of Service</h1>
                ...
                <div className='bg-white rounded-xl shadow-lg border border-orange-100 p-5 sm:p-6 md:p-8 mb-8'>
                    ...
                    <div className='mb-6 sm:mb-8'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3 flex items-center gap-2'>
                            <FontAwesomeIcon icon={faFileContract} className='text-orange-400 text-sm sm:text-base' />
                            Acceptance of Terms
                        </h2>
                    ...
                    <div className='mb-6 sm:mb-8'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3 flex items-center gap-2'>
                            <FontAwesomeIcon icon={faUserCheck} className='text-orange-400 text-sm sm:text-base' />
                            Terms for Job Applicants
                        </h2>
                        
                        <div className='space-y-3 sm:space-y-4'>
                            <div>
                                <h3 className='font-medium text-orange-700 mb-1 sm:mb-2 text-sm sm:text-base'>Information Submission</h3>
                            ...
                            <div>
                                <h3 className='font-medium text-orange-700 mb-1 sm:mb-2 text-sm sm:text-base'>Application Accuracy</h3>
                                <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                            ...
                            <div>
                                <h3 className='font-medium text-orange-700 mb-1 sm:mb-2 text-sm sm:text-base'>Communication</h3>
                                <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                            ...
                            <div>
                                <h3 className='font-medium text-orange-700 mb-1 sm:mb-2 text-sm sm:text-base'>No Guarantee of Employment</h3>
                                <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                    ...
                    <div className='mb-6 sm:mb-8'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3 flex items-center gap-2'>
                            <FontAwesomeIcon icon={faBriefcase} className='text-orange-400 text-sm sm:text-base' />
                            Terms for Employer Partners
                        </h2>
                        
                        <div className='space-y-3 sm:space-y-4'>
                            <div>
                                <h3 className='font-medium text-orange-700 mb-1 sm:mb-2 text-sm sm:text-base'>Job Postings</h3>
                                <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                            ...
                            <div>
                                <h3 className='font-medium text-orange-700 mb-1 sm:mb-2 text-sm sm:text-base'>Non-Discrimination</h3>
                                <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                            ...
                            <div>
                                <h3 className='font-medium text-orange-700 mb-1 sm:mb-2 text-sm sm:text-base'>Placement Fees</h3>
                                <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                    ...
                    <div className='mb-6 sm:mb-8'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3 flex items-center gap-2'>
                            <FontAwesomeIcon icon={faHandshake} className='text-orange-400 text-sm sm:text-base' />
                    ...
                    {/* Fees and Payment */}
                    <div className='mb-6 sm:mb-8'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3'>Fees and Payment</h2>
                        <div className='space-y-3 sm:space-y-4'>
                            <div>
                                <h3 className='font-medium text-orange-700 mb-1 sm:mb-2 text-sm sm:text-base'>For Job Seekers</h3>
                                <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                            ...
                            <div>
                                <h3 className='font-medium text-orange-700 mb-1 sm:mb-2 text-sm sm:text-base'>For Employers</h3>
                                <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                    ...
                    {/* Confidentiality */}
                    <div className='mb-6 sm:mb-8'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3'>Confidentiality</h2>
                        <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                    ...
                    <div className='mb-6 sm:mb-8'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3'>Limitation of Liability</h2>
                        <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                    ...
                    <div className='mb-6 sm:mb-8'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3 flex items-center gap-2'>
                            <FontAwesomeIcon icon={faBan} className='text-orange-400 text-sm sm:text-base' />
                    ...
                    {/* Governing Law */}
                    <div className='mb-6 sm:mb-8'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3'>Governing Law</h2>
                        <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
                    ...
                    <div className='bg-orange-50 p-4 sm:p-6 rounded-lg'>
                        <h2 className='text-base sm:text-lg md:text-xl font-medium text-orange-800 mb-3'>Questions?</h2>
                        <p className='text-gray-600 text-xs sm:text-sm leading-relaxed'>
