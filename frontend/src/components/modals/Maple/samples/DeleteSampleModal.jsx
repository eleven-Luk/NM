...
function DeleteSampleModal({ 
    ...
    sample,
    title = "Delete Sample",
    subtitle = "Are you sure you want to delete this sample?",
    loading = false
}) {
                ...
                <div className="flex-1 overflow-y-auto p-6">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-red-700">
                                    Deleting this sample will permanently remove it from your portfolio.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="mb-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-start gap-2">
                                    <FontAwesomeIcon icon={faTag} className="text-gray-400 text-sm mt-0.5" />
                                    <div className="flex-1">
                                        <p className="font-medium text-gray-900">{sample.title}</p>
                    ...
                    <div className="p-3 bg-amber-50 rounded-lg border border-amber-200">
                        <p className="text-xs text-amber-800 flex items-start gap-2">
                            ...
                            <span>
                                This will permanently delete this sample from your portfolio.
