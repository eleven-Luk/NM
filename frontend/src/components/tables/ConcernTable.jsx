...
const ConcernTable = ({
    ...
    const formatConcernType = (type) => {
        const typeMap = {
            ...
            'package-information': 'Package Information',  // Added for Maple
            'others': 'Others'
        };
    ...
    // Get additional info based on inquiry type
    const getAdditionalInfo = (concern) => {
        if (concern.inquiryType === 'employer-partnership') {
            return concern.companyName ? `Company: ${concern.companyName}` : '';
        }
        if (concern.inquiryType === 'package-information') {
            return concern.packageType ? `Package: ${concern.packageType}` : '';
        }
        return '';
    };
                        ...
                        return (
                            <tr key={concern._id} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="px-6 py-4">
                                    ...
                                    {concern.packageType && concern.inquiryType === 'package-information' && (
                                        <div className="text-xs text-gray-500 mt-1">
                                            Package: {concern.packageType}
                                        </div>
                                    )}
                                </td>
                                ...
                                {/* Actions Column */}
                                <td className="pl-10 py-4  text-md font-medium">
