// components/tables/ApplicantTable.jsx
    ...
    if (applicants.length === 0) {
        return (
            <div className="bg-white border border-gray-200 p-16 text-center">
                ...
                <p className="text-gray-500 font-light mb-2">No applicants found</p>
                        ...
                        <tr key={applicant._id} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-center">
                                <div className="flex items-center justify-center gap-2">
                                    <button
                                        onClick={() => onView && onView(applicant)}
                                    ...
                                    <button
                                        onClick={() => onEdit && onEdit(applicant)}
                                    ...
                                    <button
                                        onClick={() => onArchive && onArchive(applicant)}
                                        className="text-gray-600 hover:text-gray-900 p-1 hover:bg-gray-50 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
